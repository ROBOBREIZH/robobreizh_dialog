...
if __name__ == '__main__':
	...
	while True:
		...
		outputs_at = get_atomic_sequence(response, params[0][3], sampler_at, params[0][1], params[0][2], category)
		outputs_ct = get_conceptnet_sequence(response, params[1][3], sampler_ct, params[1][1], params[1][2],
											 relation)
