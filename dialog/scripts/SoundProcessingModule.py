...
class SoundProcessingModule(object):
	def __init__(self, app, stop_recognition):
		...
		self.dialog_topic = ""
		#file = open("/home/master/catkin_ws/src/interact/scripts/Knowledge_base/drinks.txt","r")
	...
	def startProcessing(self):
		...
		if self.dialog_type == "":
			#text = "Hi, my name is Pepper and I am the new barman! Does anyone want a drink?"
	...
	def stopRecording(self):
		...
		self.recognize_google(filename)
	...
	def sample_recognize(self, local_file_path):
		...
		if len(response.results) == 0:
			...
			for result in response.results:
				...
				# else:
				# 	self.interaction3(result, new_sentence)
	...
	def interaction3(self, features, new_sentence): 
	...
	# def move_turn(self,goal_degree):
	# 	msg = Twist()
	# 	if goal_degree<0 :
	# 		msg.angular.z=-0.5
	# 	else :
	...
	# 	sleep(6.3*abs(goal_degree)/180.0)
	# 	msg.angular.z=0.0
	# 	self.pub_turn.publish(msg)
	# 	Rate(10).sleep()
